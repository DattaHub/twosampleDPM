...
obswindow <- seq(0,70, length.out = 35)
...
plot.data <-  within(plot.data, type<- factor(type, 
                                        levels = c("Parameters","Observations","Posterior Probabilty")))
...
ggsave("art/inc-plot-4-0510-50pts.pdf", var.plot, width=5, height=7)
